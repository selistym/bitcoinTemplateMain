...
const coinColumnsLong = [
  ...
  },
  {
    ...
    render: value => {
      if(value > 100){
        return <span style={{color:'blue'}}>${numberWithCommas((value).toFixed(0))}</span>
      }else if(value < 1){
        return <span style={{color:'blue'}}>${(numberwith6decimals(value))}</span>
      }else{
  ...
  },
  {
    ...
    render: value => <span style={{color: value >= 0 ? 'green' : 'red'}}>{numberWithCommas(value.toFixed(2))} %</span>
  },
  {
    ...
    render: value => <span style={{color:'blue'}}>${numberWithCommas(value)}</span>    
  },
  {
  ...
  },
  {
    ...
    render: value => numberWithCommas(value.toFixed(2))
  },
  {
  ...
  },
  {
    ...
    render: value => '$' + numberWithCommas(numberwith6decimals(value))
  },
  {
